...
import com.rcpcompany.uibindings.internal.clipboardconverters.DelimiterResultConverter;

/**
 * {@link IFileConverter} for Comma-Separated-Values.
 * <p>
 * Very common interchange format.
 * 
 * @author Tonny Madsen, The RCP Company
 */
public class DelimiterFileConverter extends DelimiterResultConverter implements IFileConverter {
	 ...
	 */
	public DelimiterFileConverter(String name, String separatorRE) {
		super(separatorRE);
		myName = name;
	}
